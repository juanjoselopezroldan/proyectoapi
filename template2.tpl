...
<br>
	...
	<h4>Resultado numero {{c}}</h4>
		<h5>Nombre: {{a}}</h5>
		<h6>Calle: {{e}}</h6>
		<a href="https://www.google.es/maps/@{{la}}, {{lo}},20.75z?hl=es&hl=es"><img src="https://maps.googleapis.com/maps/api/staticmap?center={{la}}, {{lo}}&zoom=17&size=400x400&maptype=roadmap&key=AIzaSyBjWDRtMKtmvWpivRoLhA36w4TA6Rzxt70"></a>
		<br>
		<br>
	%end
	% if siguiente!="nada":
